                ...
                <div class="col-sm-12">
					<div class="blog-post-area">
						...
						<div class="single-blog-post">
							...
							<p>
							<a href="">
								<img src="{{asset('blog_img/'.$blog->image)}}" alt="">
							</a>
                                ...
                                for($i=0;$i<count($comment);$i++){
                                    ...
                                    for($j=$i+1;$j<count($comment);$j++){
                                        if($comment[$i]['id']==$comment[$j]['level']){
                                            echo "
                                    <li class='media second-media cmt' id='".$comment[$j]['id']."''>
                                        <a class='pull-left' href='#'>
                                            <img class='media-object' src='".asset('user_img/'.$comment[$j]['avatar'])."' width='121px' height='86px' alt=''>
								        </a>
                                        <div class='media-body'>
                                            <ul class='sinlge-post-meta'>
						...
						<div class="row">
							<div class="col-sm-8">
								<div class="text-area">
									...
									<span>*</span>
                                    <form action="/blog/public/frontend/comment/{{$id}}" method="POST" class="comment" id="">
                                        @csrf
                ...
                <script>
                    $(document).ready(function(){
                        ...
                        $("a.rep_cmt").click(function(){
                            ...
                            $("form.comment").attr('action','/blog/public/frontend/rep_comment/{{$id}}');
