...
<script>
        $(document).ready(function(){
            ...
            $("a.add-to-cart").click(function(e){
                ...
                var pro_img = "<?php echo $getArrImage['0']; ?>"
                ...
                $.ajax({
                type:'POST',
                url:"/blog/public/frontend/ajax_add-to-cart",
    ...
    <div class="product-details"><!--product-details-->
        <div class="col-sm-5">
            <div class="view-product">
                <img src="{{asset('upload/product/w329--'.$getArrImage[0])}}" alt="" />
        ...
        <div class="col-sm-7">
            <div class="product-information"><!--/product-information-->
                ...
                <p">Web ID: <span  class="pro_id">{{$product['id']}}</span></p>
