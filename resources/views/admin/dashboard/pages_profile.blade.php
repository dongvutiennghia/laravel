    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-xlg-3 col-md-5">
                <div class="card">
                    <div class="card-body">
                        <center class="m-t-30"> <img src="{{ asset('user_img/'.$avatar)}}" class="rounded-circle" width="150" />
                    ...
                    <div class="card-body">
                        <form class="form-horizontal form-material" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="username" name="name" value="{{$name}}" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    {{-- {{Auth::user()->email}} --}}
                                    {{-- {{$a}} --}}
                                    <input type="email" placeholder="email" name="email" value="{{$email}}" class="form-control form-control-line" name="example-email" id="example-email">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" placeholder="123 456 7890" name="phone" value="{{$phone}}" class="form-control form-control-line">
                                </div>
                            </div>
                            <div class="form-group">
